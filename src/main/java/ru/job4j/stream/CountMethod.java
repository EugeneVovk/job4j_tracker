 ...
 * т.е. после их вызова нельзя работать со стримом.
 ...
 * Одним из терминальных методов, который есть как в стриме объектов,
 * так и в стриме примитивов является метод count(),
