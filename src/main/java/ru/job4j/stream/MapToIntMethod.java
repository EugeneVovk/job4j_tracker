...
/**
 * 5.5. Промежуточные операции. Метод mapToInt().
 ...
 * Но что делать, если у нас стрим объектов?
 * Мы можем преобразовать стрим объектов в стрим примитивов,
 * используя методы mapToInt(), mapToDouble(), mapToLong().
 * Соответственно, в IntStream, DoubleStream, LongStream.
