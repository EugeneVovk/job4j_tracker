 ...
 * «строка».chars() - Создание стрима из строки.
 ...
 * Ваша задача преобразовать стрим, который вернет chars(),
 * в стрим Charater и собрать в список.
 * IntStream будет содержать коды символы.
 * Чтобы получить символ мы можем сделать так:
 * Charater c = (char) 91;
 */
