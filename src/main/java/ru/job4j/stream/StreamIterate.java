 ...
 * Т.е. так как мы это делаем с обычным for.
 * Arrays.stream() вернет нам стрим элементов массива, но что если нам нужен еще индекс?
 * <p>
 ...
 * <p>
 * Ниже приведен код.
 * Вам нужно заполнить ... так что обход был начиная с 0,
