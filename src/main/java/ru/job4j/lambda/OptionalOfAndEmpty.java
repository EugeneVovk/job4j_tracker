 ...
 * Во избежание подобных ситуаций, разработчики JDK решили добавить класс Optional.
 * Это класс обертка над значением. Как это спасает ситуацию?
 * Дело в том, что напрямую Optional, в некоторых местах использовать не получиться,
 * допустим у вас есть хранилище User, вам важно хранить самих User, а не Optional,
 * но например, при добавлении если у вас есть Optional, заставит вас задуматься о проверке,
 * прежде чем добавить значение.
 * <p>
