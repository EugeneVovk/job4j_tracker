...
public class BankServiceTest {
    ...
    public void add2Accounts() {
        ...
        BankService bank = new BankService();
        bank.addUser(user.get());
        bank.addAccount(user.get().getPassport(), new Account("1111", 150D));
        bank.addAccount(user.get().getPassport(), new Account("1122", 300D));
        assertThat(bank.findByRequisite("3434", "1122")
                .get().getBalance(), is(300D));
    }
}